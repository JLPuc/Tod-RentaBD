 ...
 *
 * Date Created : Tuesday, March 13, 2018 23:00:14
...
CREATE TABLE CalificacionProductos(
    IdCalificacionProducto    int    IDENTITY(1,1),
...
CREATE TABLE CalificacionUsuarios(
    IdCalificacionUsuario    int    IDENTITY(1,1),
...
CREATE TABLE ComentarioProductos(
    IdComentarioProducto    int             IDENTITY(1,1),
...
CREATE TABLE ComentarioUsuarios(
    IdComentarioUsuarios    int             IDENTITY(1,1),
...
CREATE TABLE FotoProducto(
    IdFotoProducto    int      IDENTITY(1,1),
...
CREATE TABLE FotoUsuarios(
    IdFotoUsuario    int      IDENTITY(1,1),
...
CREATE TABLE PublicacionRenta(
    IdPublicacionRenta    int     IDENTITY(1,1),
